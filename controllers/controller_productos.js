...
export const updateProduct = (req, res) => {
    ...
    if (updates.precio !== undefined) {
        if (typeof updates.precio !== 'number' || updates.precio <= 0) {
            errors.push('El precio debe ser un número mayor a 0 y numérico');
        }
    }

    if (updates.descripcion !== undefined && (typeof updates.descripcion !== 'string' || updates.descripcion.length < 10)) {
        errors.push('La descripción debe ser texto y tener al menos 10 caracteres');
    }
    ...
    const updatedProduct = {
        ...
        ...updates,
        fecha_ingreso: productos[productIndex].fecha_ingreso 
    };
